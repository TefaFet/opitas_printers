...
<body>
  ...
  <main>
    ...
    <section class="py-5 text-center container">
      <div class="row py-lg-2">
        <div class="col-lg-6 col-md-8 mx-auto">
          ...
          <h1 class="fw-light">OPITAS PRINTERS DAES</h1>
          <p class="lead text-muted">Prestación de servicios de alquiler de impresoras en la ciudad de Neiva. </p>
          <p class="lead text-muted">Estás interesado en alquilar? </p>

          <a href="http://localhost/opitas_printers/index.php/login" type="button" class="btn btn-sm btn-outline-info">Registrate</a>
    ...
    <img style="margin-top:2rem;margin-left:2rem;" src="http://localhost/opitas_printers/asset/img/centro_servicio.jpg" width="720px%" height="400px" alt="">
    <img style="margin-top:2rem;margin-right:2rem;"src="http://localhost/opitas_printers/asset/img/servicio.png" width="46%" height="400opx" alt="">
                    ...
                    <div class="col-3">
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-info" data-bs-toggle="modal" data-bs-target="#comprar<?= $t->id ?>">
                                    Alquilar
                                </button>
                                
                                <a class="btn btn-sm btn-outline-info" href="<?=base_url()?>Controller/<?= $t->ruta ?>"type="button" >Funciones</a>
                                        ...
                                        <div class="modal-content">
                                            <form action="<?= base_url() ?>/Impresoras/inserthisto/<?= $t->id ?>" method="post">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-info btn-sm">Alquilar</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
