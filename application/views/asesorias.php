  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">ASESORIAS</h1>
        <p class="lead text-muted">Te brindamos la mejor opcion de impresoras que sea idonea a tu empresa. </p>
        <a href="http://localhost/opitas_printers/index.php/login" type="button" class="btn btn-sm btn-outline-info">Registrarse</a>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          ...
          <img src="https://www.cyberpuerta.mx/img/product/L/CP-LEXMARK-29S0150-1.jpg" aheight="300" width="400">
            <div class="card-body">
              <p class="card-text">  Impresora Lexmark 29S0150</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <a href="http://localhost/opitas_printers/index.php/Controller/Impresora_Lexmark_29S0150" type="button" class="btn btn-sm btn-outline-info">Funciones</a>
        ...
        <div class="col">
          <div class="card shadow-sm">
          <img src="https://exitocol.vtexassets.com/arquivos/ids/12110922-800-auto?v=637828723833500000&width=800&height=auto&aspect=true" aheight="300" width="300">

            <div class="card-body">
              <p class="card-text">Impresora Canon Maxify GX6010</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <a href="http://localhost/opitas_printers/index.php/Controller/Impresora_Canon_Maxify_GX6010" type="button" class="btn btn-sm btn-outline-info">Funciones</a>
        ...
        <div class="col">
          <div class="card shadow-sm">
          <img src="https://www.hp.com/es-es/shop/Html/Merch/Images/c06991812_1750x1285.jpg" aheight="300" width="400">

            <div class="card-body">
              <p class="card-text">Impresora HP Laserjet Enterprise M555dn</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <a href="http://localhost/opitas_printers/index.php/Controller/Impresora_HP_Laserjet_Enterprise_M555dn" type="button" class="btn btn-sm btn-outline-info">Funciones</a>
        ...
        <div class="col">
          ...
          <img src="https://colombia.com.co/wp-content/uploads/2022/07/Impresora-multifuncio%CC%81n-HP-Color-LaserJet-Enterprise-M578dn-Comercializadora-Link-01.jpg" aheight="300" width="300">
            ...
            <div class="card-body">
              <p class="card-text"> Impresora HP Laserjet Enterprise MFPM578DN</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <a href="http://localhost/opitas_printers/index.php/Controller/Impresora_HP_Laserjet_Enterprise_MFPM578DN" type="button" class="btn btn-sm btn-outline-info">Funciones</a>
        ...
        <div class="col">
          <div class="card shadow-sm">
          <img src="https://www.ricoh-americalatina.com/-/media/Ricoh/Common/Images/products/Equipment/Detail/Eqp-MP-305SPF-10.png" aheight="300" width="263">

            <div class="card-body">
              <p class="card-text">RICOH MP 305 SPF Impresora multifunción láser en blanco y negro</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <a href="RICOH_Impresora_laserdos" type="button" class="btn btn-sm btn-outline-info">Funciones</a>
        ...
        <div class="col">
          ...
          <img src="http://copitex.co/images/virtuemart/product/mp_c2050-1.jpg" aheight="300" width="345    ">
            ...
            <div class="card-body">
              <p class="card-text">RICOH MP C2050 Impresora Multifunción Láser Color</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <a href="RICOH_MP_Impresora_multi" type="button" class="btn btn-sm btn-outline-info">Funciones</a>
